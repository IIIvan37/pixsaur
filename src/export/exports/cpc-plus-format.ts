 ...
 */
export function paletteToCPCPlusData(
 ...
 */
export function paletteToCPCPlusValues(
  palette: Array<[number, number, number]>
): number[] {
 ...
 */
export function cpcPlusValuesToASM(
  cpcValues: number[],
  labelName: string
): string {
 ...
 */
export function injectCPCPlusPaletteIntoSCR(
  scr: Uint8Array,
  cpcPalette: number[]
): void {
  if (scr.length < 2048) {
