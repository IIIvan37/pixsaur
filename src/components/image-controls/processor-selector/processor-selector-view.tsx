...
export const ProcessorSelectorView = ({
  ...
  return (
    <div className={styles.container}>
      <label className={styles.label}>Processeur:</label>
      <div className={styles.options}>
        <label className={styles.option}>
          ...
          <span className={styles.optionLabel}>
            Auto
            {!hasWebGL && <span className={styles.cpuOnly}> (CPU uniquement)</span>}
          </span>
        </label>
        ...
        <label className={`${styles.option} ${!hasWebGL ? styles.disabled : ''}`}>
          <input
            type="radio"
            name="processor"
            value="gpu"
          ...
          <span className={styles.optionLabel}>
            GPU
            {!hasWebGL && <span className={styles.unavailable}> (Non disponible)</span>}
          </span>
        </label>
      </div>
    </div>
