 ...
 */
function parseViewBoxDimensions(viewBox: string): { width: number; height: number } {
 ...
 */
function parseWidthHeightAttributes(svg: SVGSVGElement): { width: number; height: number } {
